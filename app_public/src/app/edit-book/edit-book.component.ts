...
export class EditBookComponent implements OnInit {
  ...
  public posodobiKnjigo(): void {
    this.mainPicture();
    this.curentBook.pictures[0] = localStorage.getItem('pic0') + '';
    this.curentBook.pictures[1] = localStorage.getItem('pic1') + '';
    this.curentBook.pictures[2] = localStorage.getItem('pic2') + '';
    this.curentBook.pictures[3] = localStorage.getItem('pic3') + '';
    this.curentBook.pictures[4] = localStorage.getItem('pic4') + '';

    //console.log(this.curentBook);
    this.editBookError = "";
    this.logged = this.layout.getCurrentUser();
    this.curentBook.sellerId = this.logged._id;
    this.curentBook.sellerName = this.logged.name;
    if (this.preveriPodatke()) {
      this.bookstorDataService
        .editBook(this.logged._id, this.curentBook._id, this.curentBook)
        .subscribe({
          next: (knjiga) => {
            console.log("knjiga posodobljena" + knjiga)
            this.router.navigate(['/books/myBooks']);
          },
          error: (napaka) => {
            this.editBookError = napaka;
          },
        });
    }
  }
  ...
  private preveriPodatke() {
    ...
    if (this.curentBook.title == '' ||
      Number.isNaN(this.curentBook.bookReleaseYear) ||
      this.curentBook.genres[0] == undefined) {
      alert("Required fields: Title, Book release year, Genre")
      return false;
    }
    if (!Web3.utils.isAddress(this.curentBook.ethereumAddress) && this.curentBook.ethereumAddress !== '') {
  ...
  public showPictures() {
    localStorage.setItem('pic0', this.curentBook.pictures[0]);
    localStorage.setItem('pic1', this.curentBook.pictures[1]);
    localStorage.setItem('pic2', this.curentBook.pictures[2]);
    localStorage.setItem('pic3', this.curentBook.pictures[3]);
    localStorage.setItem('pic4', this.curentBook.pictures[4]);

    if (this.curentBook.pictures[0] != "") {
      document
        .querySelector("#slikaURL0")!
        .setAttribute("value", localStorage.getItem('pic0') + '');
      document.querySelector("#slika0")!.setAttribute("src", localStorage.getItem('pic0') + '');
      document.querySelector("#slika0")!.removeAttribute("hidden");
      document.querySelector("#remove0")!.removeAttribute("hidden");
    }
    if (this.curentBook.pictures[1] != "") {
      document
        .querySelector("#slikaURL1")!
        .setAttribute("value", localStorage.getItem('pic1') + '');
      document.querySelector("#slika1")!.setAttribute("src", localStorage.getItem('pic1') + '');
      document.querySelector("#slika1")!.removeAttribute("hidden");
      document.querySelector("#remove1")!.removeAttribute("hidden");
    }
    if (this.curentBook.pictures[2] != "") {
      document
        .querySelector("#slikaURL2")!
        .setAttribute("value", localStorage.getItem('pic2') + '');
      document.querySelector("#slika2")!.setAttribute("src", localStorage.getItem('pic2') + '');
      document.querySelector("#slika2")!.removeAttribute("hidden");
      document.querySelector("#remove2")!.removeAttribute("hidden");
    }
    if (this.curentBook.pictures[3] != "") {
      document
        .querySelector("#slikaURL3")!
        .setAttribute("value", localStorage.getItem('pic3') + '');
      document.querySelector("#slika3")!.setAttribute("src", localStorage.getItem('pic3') + '');
      document.querySelector("#slika3")!.removeAttribute("hidden");
      document.querySelector("#remove3")!.removeAttribute("hidden");
    }
    if (this.curentBook.pictures[4] != "") {
      document
        .querySelector("#slikaURL4")!
        .setAttribute("value", localStorage.getItem('pic4') + '');
      document.querySelector("#slika4")!.setAttribute("src", localStorage.getItem('pic4') + '');
      document.querySelector("#slika4")!.removeAttribute("hidden");
      document.querySelector("#remove4")!.removeAttribute("hidden");
    }
  }
